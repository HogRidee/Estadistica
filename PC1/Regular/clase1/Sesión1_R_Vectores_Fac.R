...
vec1[4] #el 2do elemento del vector1
...
2 * v1 + 3
v1^2 # a cada elemento de v1 al cuadrado
...
mean(w) #promedio
#Interpretacion
# el promedio de los elementos de w es 25.5

median(w) #mediana
#Interpretacion
# el 50% inferior de los elementos de w tienen 
# un valor maximo de 20.5
# el 50% superior de los elementos de w tienen 
# un valor minimo de 20.5

quantile(w) #te extrae los percentiles mas importantes
# P25 = 7.75 # Cuartil
# interpretacion
# el 25% inferior de los elementos de w
# tienen un valor maximo de 7.75
# el 75% superior de los elementos de w
# tienen un valor minimo de 7.75

# P75 = 39.25 #Cuartil 3
# interpretacion
# el 75% inferior de los elementos de w
# tienen un valor maximo de 39.25
# el 25% superior de los elementos de w
# tienen un valor minimo de 39.25

quantile(w, probs = 0.10) # Percentil 10
#Interpretacion
# el 10% inferior de los elementos de w 
# tienen un valor maximo de 3.1
# el 90% superior de los elementos de w 
# tienen un valor minimo de 3.1

quantile(w, probs = 0.90)
#Interpretacion
# el 90% inferior de los elementos de w 
# tienen un valor maximo de 53.5 
# el 10% superior de los elemento de w 
# tienen un valor minimo de 53.5
