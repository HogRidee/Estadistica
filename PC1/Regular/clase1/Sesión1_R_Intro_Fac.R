...
getwd()
setwd("D:/JHON/DMC/Fundamentos de programaci?n con R/modulo 1/1.2 material de practica")
file.choose()
...
numero
objeto2
producto<- numero*objeto2
producto
suma<- numero+objeto2
suma
?_3.resta<- numero-objeto2
?_3.resta
Objeto2
Numero

name<- "Carmen"
rm(name1) #borrar una variable
name1<- "Jose"
rm(name1)
name1
name
...
options(digits=9) #utilizamos 9 cifras decimales
pi
2/3
sqrt(2)
